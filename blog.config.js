...
const BLOG = {
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'wZrqkJqk_RwhG7EGnpYwm',
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-preview1-0.vercel.app', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-NKQ2MRJZWH', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
